					...
					<div class="panel-content">
						<div class="panel-content">
							<div class="bg-warning-100 border border-warning rounded">
								...
								<?php
								$lists = [
									['tags' => 'reports file', 'task' => 'Reports'],
									['tags' => 'analytics graphs', 'task' => 'Analytics'],
									['tags' => 'export download', 'task' => 'Export'],
									['tags' => 'storage', 'task' => 'Storage']
								];
								?>
								...
								<ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
									...
									<?php foreach ($lists as $list) : ?>
										<li class="list-group-item">
											<span data-filter-tags="<?= $list['tags'] ?>"><?= $list['task'] ?></span>
										</li>
									<?php endforeach; ?>
